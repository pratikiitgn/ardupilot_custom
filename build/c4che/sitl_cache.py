...
CXX_TGT_F = ['-c', '-o']
DEBUG = False
DEFINES = ['SKETCHBOOK="/home/pratik/pratik_github/ardupilot_custom"', 'AP_SCRIPTING_CHECKS=1', 'CONFIG_HAL_BOARD=HAL_BOARD_SITL', 'CONFIG_HAL_BOARD_SUBTYPE=HAL_BOARD_SUBTYPE_NONE', 'ENABLE_HEAP=1', 'ENABLE_ONVIF=0', 'ENABLE_SCRIPTING=1', 'HAL_PROBE_EXTERNAL_I2C_BAROS=1', 'LUA_32BITS=1', 'UAVCAN_CPP_VERSION=UAVCAN_CPP03', 'UAVCAN_NO_ASSERTIONS=1', 'UAVCAN_NULLPTR=nullptr']
DEFINES_ST = '-D%s'
...
HAVE_MEMRCHR = 1
HWDEF_EXTRA = None
INCLUDES = ['/home/pratik/pratik_github/ardupilot_custom/libraries/', '/home/pratik/pratik_github/ardupilot_custom/libraries/AP_Common/missing', '/home/pratik/pratik_github/ardupilot_custom/modules/uavcan/libuavcan/include']
LIB = ['m']
LIBDIR = '/usr/lib'
LIBPATH_ST = '-L%s'
LIB_ST = '-l%s'
...
TOOLCHAIN = 'native'
cfg_files = ['/home/pratik/pratik_github/ardupilot_custom/build/sitl/ap_config.h']
cprogram_PATTERN = '%s'
