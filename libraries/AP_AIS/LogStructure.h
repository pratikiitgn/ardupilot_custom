...
#define LOG_STRUCTURE_FROM_AIS \
    { LOG_AIS_RAW_MSG, sizeof(log_AIS_raw),"AISR",  "QBBBZ", "TimeUS,num,total,ID,payload", "s----", "F0000" }, \
    { LOG_AIS_MSG1, sizeof(log_AIS_msg1), "AIS1",  "QBBIBbHbLLHHBBbI", "US,typ,rep,mmsi,nav,rot,sog,pos,lon,lat,cog,hed,sec,man,raim,rad", "s---------------", "F000000000000000" }, \
    { LOG_AIS_MSG4, sizeof(log_AIS_msg4), "AIS4",  "QBIHBBBBBBLLBBI", "US,rep,mmsi,year,mth,day,h,m,s,fix,lon,lat,epfd,raim,rad", "s--------------", "F00000000000000" },\
    { LOG_AIS_MSG5, sizeof(log_AIS_msg5), "AIS5",  "QBIBINZBHHBBBBZB", "US,rep,mmsi,ver,imo,cal,nam,typ,bow,stn,prt,str,fix,dght,dst,dte", "s-------mmmm-m--", "F------------A--" }
